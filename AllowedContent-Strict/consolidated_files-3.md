...
Output written on main_clean.pdf (63 pages).
...
\textbf{Hours:} Thursday–Sunday, 12:00 PM – 6:00 PM
...
\section*{Wine Trail Connections}
...
\subsection*{Getting the Most from Groups}
...
\begin{itemize}[leftmargin=*, topsep=0pt, itemsep=3pt]
\item Logs or trunks larger than 6" diameter
\item Treated lumber or construction wood
\item Yard waste (leaves, grass clippings)
\item Root balls or stumps
\item Poison ivy, oak, or sumac
\item Non-organic materials mixed with brush
\end{itemize}
\end{tcolorbox}
\end{minipage}
...
\begin{itemize}[leftmargin=*]
\item \textbf{Cut to Length:} Branches should be no longer than 8 feet for easier handling
\item \textbf{Remove Debris:} Clear any rocks, wire, or non-organic material from brush piles
\item \textbf{Sort by Size:} Separate smaller branches from larger limbs when possible
\item \textbf{Accessibility:} Pile materials in areas accessible to chipper and vehicles
\item \textbf{Safety Clearance:} Keep piles away from power lines, buildings, and vehicles
\end{itemize}

\subsection*{Staging \& Collection}

\begin{itemize}[leftmargin=*]
\item \textbf{Advance Notice:} Submit requests at least 2 weeks before planned chipping events
\item \textbf{Property Access:} Ensure clear access routes for equipment and volunteers
\item \textbf{Pile Location:} Stage materials near road access but not blocking traffic
\item \textbf{Weather Considerations:} Events may be postponed for safety during wet conditions
\item \textbf{Property Owner Presence:} Owner or representative should be available during chipping
\end{itemize}

\section*{Chipping Event Process}

\subsection*{Typical Event Timeline}

\textbf{Pre-Event (1-2 weeks prior)}
\begin{itemize}[leftmargin=*]
\item Community notification via Facebook groups and email
\item Property owners submit requests and prepare materials
\item Route planning and equipment preparation
\item Volunteer coordination and safety briefing scheduled
\end{itemize}

\textbf{Event Day}
\begin{itemize}[leftmargin=*]
\item \textbf{Start Time:} Typically 8:00 AM - 4:00 PM (weather permitting)
\item \textbf{Safety Briefing:} All volunteers receive equipment and safety training
\item \textbf{Route Execution:} Systematic processing of submitted requests
\item \textbf{Quality Control:} Materials inspection before processing
\item \textbf{Mulch Distribution:} Chips available for community use and property owners
\end{itemize}

\textbf{Post-Event}
\begin{itemize}[leftmargin=*]
\item Equipment cleaning and maintenance
\item Excess mulch distribution to community areas
\item Event summary and feedback collection
\item Planning for next scheduled event
\end{itemize}

\section*{Volunteer Opportunities}

\subsection*{Equipment Operation}

\textbf{Chipper Operators:} Experienced volunteers trained in safe equipment operation
\begin{itemize}[leftmargin=*]
\item Must complete safety training and demonstrate competency
\item Responsible for equipment setup, operation, and maintenance
\item Minimum age 18, previous equipment experience preferred
\item Physical demands: Heavy lifting, prolonged standing, noise exposure
\end{itemize}

\subsection*{Support Volunteers}

\textbf{Material Handlers:} Community members who assist with feeding and cleanup
\begin{itemize}[leftmargin=*]
\item Help drag and position branches for chipping
\item Assist with sorting and quality control
\item Manage mulch collection and distribution
\item Minimum age 16 with adult supervision
\item Safety equipment provided (gloves, eye protection, ear protection)
\end{itemize}

\subsection*{Coordination Support}

\textbf{Event Coordinators:} Help with planning, communication, and logistics
\begin{itemize}[leftmargin=*]
\item Collect and organize chipping requests
\item Plan routes and coordinate with property owners
\item Manage volunteer schedules and communication
\item Handle equipment rentals and transportation
\item Flexible time commitment based on availability
\end{itemize}
...
\begin{tcolorbox}[
  colback=red!5,
  colframe=red!75!black,
  title={\sffamily\bfseries Safety Standards \& Equipment},
  fonttitle=\bfseries\sffamily,
  boxrule=2pt
]
\begin{minipage}[t]{0.48\textwidth}
\textbf{Required Personal Protective Equipment}
\begin{itemize}[leftmargin=*, topsep=2pt, itemsep=2pt]
\item Safety glasses or face shields
\item Hearing protection (ear plugs or muffs)
\item Work gloves (leather or heavy-duty)
\item Long pants and closed-toe shoes
\item Long-sleeved shirts recommended
\end{itemize}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.48\textwidth}
...
\begin{itemize}[leftmargin=*, topsep=2pt, itemsep=2pt]
\item Mandatory safety briefing before participation
\item Minimum safe distance from chipper discharge
\item No loose clothing or jewelry near equipment
\item Clear communication protocols during operation
\item First aid kit and emergency contacts on-site
\end{itemize}
\end{minipage}
\end{tcolorbox}

\section*{Mulch Distribution \& Use}

\subsection*{Mulch Benefits \& Applications}

\begin{minipage}[t]{0.48\textwidth}
\textbf{Garden \& Landscaping Uses}
\begin{itemize}[leftmargin=*, topsep=0pt, itemsep=3pt]
\item Moisture retention around trees
\item Weed suppression in garden beds
\item Soil improvement as organic matter
\item Temperature regulation for roots
\item Erosion control on slopes
\end{itemize}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.48\textwidth}
\textbf{Community Applications}
\begin{itemize}[leftmargin=*, topsep=0pt, itemsep=3pt]
\item Trail surface improvement
\item Playground safety surfaces
\item Common area landscaping
\item Fire break maintenance (aged mulch)
\item Composting material
\end{itemize}
\end{minipage}

\subsection*{Mulch Collection Guidelines}

\begin{itemize}[leftmargin=*]
\item \textbf{Property Owner Priority:} Property owners whose material was chipped have first priority
\item \textbf{Community Sharing:} Excess mulch available to all community members
\item \textbf{Transportation:} Property owners responsible for loading and transporting mulch
\item \textbf{Fresh Mulch Considerations:} Allow 2-4 weeks aging before use around sensitive plants
\item \textbf{Storage:} Store mulch in well-drained areas away from buildings
\end{itemize}

\infobox{How to Participate}{
\textbf{Request Chipping Service:} Contact any BMPOA board member to submit your property for inclusion in the next chipping event. Provide your address, estimated volume, and material type.

\textbf{Volunteer for Events:} Help make the program successful by volunteering for equipment operation, material handling, or event coordination. Training provided for all roles.

\textbf{Stay Informed:} Follow our Facebook groups for announcements about upcoming chipping events, volunteer opportunities, and program updates.

\textbf{Contribute Equipment or Resources:} The program relies on community support for equipment rental, fuel, and maintenance costs. Contact the board about supporting the program.
}
...
% TRILLIUMS & WILDFLOWERS - PAGE 18
% =================================

\chapter*{Trilliums}
\addcontentsline{toc}{chapter}{Trilliums}

\begin{center}
%\includegraphics[width=0.8\textwidth]{../assets/images/trillium-bloom-thompson-wma.jpeg}\\[0.3cm]
\textit{Figure 12: Trillium Bloom at Thompson Wildlife Management Area}
\end{center}

\section*{Local Abundance}

Thompson Wildlife Management Area hosts an estimated 18 million Great White Trilliums (\textit{Trillium grandiflorum}). Peak bloom occurs in late April to early May each year. The "Trillium Trail" event draws nature enthusiasts from across the region.

\section*{Viewing Areas \& Access}

\subsection*{Trillium Trail Loop}

\begin{itemize}[leftmargin=*]
\item Trailhead off Freezeland Road (GPS: 38.9670° N, 78.4710° W). Moderate 1-mile loop with minimal elevation gain.
\item Marked path meandering through dense trillium colonies under a hardwood canopy.
\end{itemize}

\subsection*{Appalachian Trail Connector}

\begin{itemize}[leftmargin=*]
\item Starts at the AT parking area off Route 340/211 (GPS: 38.9920° N, 78.4490° W).
\item Connects to Blue Mountain ridge; 2-mile round-trip, $\sim$700 ft elevation gain.
\end{itemize}

\subsection*{Freezeland Road Access}

\begin{itemize}[leftmargin=*]
\item Parking pull-off for $\sim$3 cars; short, unmarked 0.2-mile path into the forest.
\item Steep, rocky path—hiking boots recommended.
\end{itemize}

\section*{Other Notable Flora}

\begin{itemize}[leftmargin=*]
\item Lady's Slippers (\textit{Cypripedium spp.}) in damp seep areas.
\item Showy Orchids (\textit{Calopogon tuberosus}) in boggy meadows.
\item Virginia Bluebells (\textit{Mertensia virginica}) lining creekbanks in early spring.
\end{itemize}

\textit{For more information on native plants in our area, see \textbf{Plant Ridge \& Valley Natives (page 17)}. Trail maps and access points are detailed in \textbf{Hiking Trails on Blue Mountain (page 15)}.}

\section*{Conservation Tips}

\begin{itemize}[leftmargin=*]
\item Do not pick or transplant trilliums—they require 9+ years to reach flowering maturity.
\item Stay on designated trails to protect fragile understory.
\item Leave no trace: Pack out all trash, and avoid trampling wildflowers.
\item Report illegal picking to DWR or local wildlife wardens.
\end{itemize}
...
% NATIVE PLANTS & LANDSCAPING - PAGE 17
% =====================================

\chapter*{Plant Ridge \& Valley Natives}
\addcontentsline{toc}{chapter}{Native Plants}

\infobox{Why Native Plants Matter}{
\textbf{Environmental Benefits:} Native plants provide critical ecosystem services that non-native species cannot match. They stabilize soil and improve water quality by reducing erosion and runoff, making them essential for protecting our mountain environment.

\textbf{Wildlife Support:} Native plants provide habitat and food for pollinators including bees and butterflies, as well as wildlife such as birds and small mammals. They form the foundation of healthy ecosystem food webs.

\textbf{Climate Benefits:} Native species sequester more CO₂ than non-native species, helping with climate mitigation efforts while enhancing biodiversity and ecosystem resilience in the Ridge \& Valley region.
}

\begin{center}
%\includegraphics[width=0.8\textwidth]{../assets/images/virginia-bluebells.jpeg}\\
\textit{Figure 4: Virginia Bluebells - A Native Spring Beauty}
\end{center}

\section*{Recommended Native Species}

\subsection*{Perennials \& Ground Cover}
...
\textbf{Spring Bloomers} & \textbf{Summer \& Fall Bloomers} \\
\begin{itemize}[leftmargin=*, topsep=0pt]
\item \textbf{Bloodroot} (Sanguinaria canadensis)
\item \textbf{Wild Geranium} (Geranium maculatum)
\item \textbf{Trillium} (Trillium grandiflorum)
\item \textbf{Dutchman's Breeches} (Dicentra cucullaria)
\item \textbf{Foam Flower} (Tiarella cordifolia)
\item \textbf{Wild Ginger} (Asarum canadense)
\end{itemize} &
\begin{itemize}[leftmargin=*, topsep=0pt]
\item \textbf{Wild Bee Balm} (Monarda fistulosa)
\item \textbf{Milkweed} (Asclepias spp.)
\item \textbf{Narrow-Leaf Mountain Mint} (Pycnanthemum tenuifolium)
\item \textbf{Lavender} (Lavandula angustifolia) – locally adapted cultivar
\end{itemize}
\end{tabular}
\end{tcolorbox}
...
\begin{itemize}[leftmargin=*]
\item \textbf{Coral Honeysuckle} (Lonicera sempervirens) – Native alternative to invasive honeysuckle
\end{itemize}

\subsection*{Shrubs}

\begin{itemize}[leftmargin=*]
\item \textbf{Oak Leaf Hydrangea} (Hydrangea quercifolia) – Beautiful fall color
\item \textbf{Shrubby St. John's Wort} (Hypericum prolificum) – Yellow summer blooms
\end{itemize}

\section*{Where to Buy Native Plants}

\subsection*{Local Nurseries}

\begin{itemize}[leftmargin=*]
\item \textbf{Seven Bends Nursery} – Berryville, VA (sevenbends.org)
\item \textbf{Yellow House Natives} – Berryville (via VA Native Plant Society: vaplantatlas.org)
\end{itemize}

\subsection*{Online Resources}

\begin{itemize}[leftmargin=*]
\item \textbf{Virginia Plant Atlas} – vaplantatlas.org (distribution maps, seed sources)
\item \textbf{Plant Virginia Natives} – plantvirginianatives.org (download "Plant Ridge \& Valley Natives" PDF)
\end{itemize}

\section*{Deer-Resistant Native Plants}

\subsection*{Ferns, Grasses \& Sedges}

Most are unpalatable to deer:
\begin{itemize}[leftmargin=*]
\item Christmas Fern
\item Native sedges
\end{itemize}
...
\begin{itemize}[leftmargin=*]
\item \textbf{Arrowwood Viburnum} (Viburnum dentatum)
\item \textbf{Buttonbush} (Cephalanthus occidentalis)
\item \textbf{Chokeberry} (Aronia arbutifolia)
\item \textbf{Mountain Laurel} (Kalmia latifolia)
\item \textbf{Silky Dogwood} (Cornus amomum)
\item \textbf{Winterberry} (Ilex verticillata)
\end{itemize}

\subsection*{Trees}

\begin{tabular}{p{0.48\textwidth}p{0.48\textwidth}}
\textbf{Large Trees} & \textbf{Small Trees \& Understory} \\
\begin{itemize}[leftmargin=*, topsep=0pt]
\item \textbf{Black Gum} (Nyssa sylvatica)
\item \textbf{Cucumber Magnolia} (Magnolia acuminata)
\item \textbf{Sycamore} (Platanus occidentalis)
\item \textbf{Tulip Poplar} (Liriodendron tulipifera)
\item \textbf{Umbrella Magnolia} (Magnolia tripetala)
\end{itemize} &
\begin{itemize}[leftmargin=*, topsep=0pt]
\item \textbf{American Holly} (Ilex opaca)
\item \textbf{Flowering Dogwood} (Cornus florida)
\item \textbf{Serviceberry} (Amelanchier arborea)
\item \textbf{Eastern Red Cedar} (Juniperus virginiana)
\item \textbf{Pawpaw} (Asimina triloba)
...
Contact the Architectural Review Committee early in your planning process. They can provide guidance that saves time and money. Email: }
